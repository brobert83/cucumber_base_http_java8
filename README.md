# Base for Cucumber HTTP steps [![Build Status](https://travis-ci.org/brobert83/cucumber_base_http_java8.svg?branch=master)](https://travis-ci.org/brobert83/cucumber_base_http_java8)
